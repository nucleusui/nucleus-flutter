...
import 'package:nucleus_ui/package/tooltip/utils/get_axis_direction.dart';
import 'package:nucleus_ui/package/tooltip/utils/get_position_dependent_offset.dart';
...
class RenderPositionedTooltip extends RenderShiftedBox
  ...
  Path _paintTail({
    ...
    switch (axisDirection) {
      ...
      case AxisDirection.left:
        ...
        final offsetTarget = target.translate(-offset - targetWidthRadius, 0);
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    // Is it necessary to fill these twice, once in the parent and once here?
    properties
      ..add(
      ...
      ..add(ObjectFlagProperty<TailBuilder>.has('tailBuilder', tailBuilder))
      ..add(DoubleProperty('offsetAndTailLength', offsetAndTailLength));
  }
}
