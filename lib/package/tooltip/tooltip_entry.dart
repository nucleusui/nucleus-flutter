...
/// skrim to the outer [TooltipArea]. This class is useless if not
/// nested within a [TooltipArea].
///
/// {@macro just_the_tooltip.overlay.constructor}
class TooltipEntry extends StatefulWidget implements HoverInterface {
  const TooltipEntry({
    super.key,
  ...
  @override
  TooltipState<Widget> createState() => _TooltipEntryState();
}

// https://stackoverflow.com/a/65854697/8213910
class _TooltipEntryState extends TooltipState<Widget> {
  ...
  void _createNewEntries() {
    ...
    TooltipArea.of(context).setEntries(entry: entry, skrim: skrim);
  }
  ...
  void _updateEntries() {
    ...
    TooltipArea.of(context).updateEntries(entry: entry, skrim: skrim);
  }
