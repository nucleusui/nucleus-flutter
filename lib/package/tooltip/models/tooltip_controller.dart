...
import 'package:nucleus_ui/package/tooltip/just_the_tooltip.dart';
...
class TooltipController extends ValueNotifier<TooltipStatus> {
  // This value is not refelected in the initial state of the tooltip
  TooltipController({TooltipStatus? value})
