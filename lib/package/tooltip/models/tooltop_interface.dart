...
/// {@endtemplate}
abstract class HoverInterface extends StatefulWidget {
  const HoverInterface({super.key});
  ...
  TooltipController? get controller;
  ...
  // The tail should be able to be colored a different color but should
