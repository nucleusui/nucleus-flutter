...
|-----------------------|--------------------------|----------------------------------|-----------------------------------------------------------------------------|
| `value`               | `double`                 | **Required**                     | The progress value as a percentage (0-100).                                 |
| `label`               | `String?`                | `undefined`                      | The primary label displayed alongside the progress bar.                     |
| `secondaryLabel`      | `String?`                | `undefined`                      | The secondary label displayed alongside the progress bar.                   |
| `backgroundColor`     | `Color?`                 | `context.color.bgMuted`          | The background color of the progress bar.                                   |
| `color`               | `Color?`                 | `context.color.accentModerate`   | The color of the progress indicator.                                        |
| `valueColor`          | `Animation<Color?>?`     | `undefined`                      | The animation for the progress indicator color.                             |
| `minHeight`           | `double`                 | `8`                              | The minimum height of the progress bar.                                     |
| `borderRadius`        | `BorderRadiusGeometry?`  | `BorderRadius.circular(999)`     | The border radius of the progress bar.                                      |
| `stopIndicatorColor`  | `Color?`                 | `undefined`                      | The color of the stop indicator.                                            |
| `stopIndicatorRadius` | `double?`                | `undefined`                      | The radius of the stop indicator.                                           |
| `trackGap`            | `double?`                | `undefined`                      | The gap between the progress track and the stop indicator.                  |
| `verticalPadding`     | `double`                 | `24`                             | The vertical padding around the progress bar.                               |
| `alignment`           | `AlignmentGeometry`      | `Alignment.bottomLeft`           | The alignment of the progress bar and labels.                               |
